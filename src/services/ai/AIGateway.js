...
class AIGateway {
  ...
  init() {
    // 从环境变量加载各平台API Key
    const configs = {
      deepseek: { apiKey: process.env.DEEPSEEK_API_KEY || '', baseUrl: 'https://api.deepseek.com/v1', models: ['deepseek-chat'] },
      aliyun: { apiKey: process.env.BAILIAN_API_KEY || '', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', models: ['qwen-turbo'] },
